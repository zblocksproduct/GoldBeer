      ...
      <div className="bg-[#163113] sm:mt-[120px] mt-[80px] sm:pt-[120px] pt-[80px] xl:px-0 px-[25px]">
        <div className="max-w-[924px] w-[100%] m-auto">
          ...
          <div className="sm:flex justify-center sm:mt-20 mt-[60px]">
            <div
              className="sm:w-[317px] w-[100%] h-[68px] rounded-[6px] flex justify-center items-center"
            ...
            <div
              className="sm:w-[317px] w-[100%] h-[68px] rounded-[6px] flex justify-center items-center sm:ml-[30px] sm:mt-0 mt-[21px]"
              style={{ background: "rgba(255, 255, 255, 0.30)" }}
            >
